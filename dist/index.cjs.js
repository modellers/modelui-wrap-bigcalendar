...
var events = _objectSpread2(_objectSpread2({}, modeluiCoreRuntime.structs.ListBase.events), calendarEvents);
var triggers = modeluiCoreRuntime.structs.ListBase.triggers;
var config = {
  name: "Big Calendar",
  type: "calendar-big",
  ...
  options: options,
  state: modeluiCoreRuntime.structs.ListBase.StateList
  ...
  _createClass(BigCalendarComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default["default"].createElement("div", {
        classes: classes
      }, /*#__PURE__*/React__default["default"].createElement(reactBigCalendar.Calendar, {
        ...
        */
        ...
        ,
        defaultDate: moment__default["default"]().toDate() // defaultDate={new Date(2015, 3, 12)}
        ,
...
}(modeluiCoreRuntime.structs.ListBase.ListBase); // export default withStyles(style, { withTheme: true })(BigCalendarComponent);

function BigCalendar(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default["default"].createElement(BigCalendarComponent, props);
}
